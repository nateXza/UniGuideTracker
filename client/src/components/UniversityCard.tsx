...
const UniversityCard: React.FC<UniversityCardProps> = ({ university, onClick }) => {
  ...
  return (
    <Card className="bg-card overflow-hidden shadow-lg rounded-lg border border-gray-200 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      <div className="relative">
        ...
        {university.accommodationAvailable && (
          <div className="absolute top-0 right-0 m-3">
            <Badge variant="outline" className="bg-card bg-opacity-90 text-green-600 border-green-600">
              Accommodation
            </Badge>
          </div>
        )}
        ...
        <div className="absolute -bottom-10 left-6">
          <div className="w-20 h-20 rounded-full bg-card shadow-lg border-4 border-white overflow-hidden flex items-center justify-center">
            <img 
      ...
      <CardContent className="p-6 pt-12 flex-grow">
        <div className="flex justify-between items-start mb-3">
          <h3 className="text-xl font-bold text-foreground hover:text-primary-600 transition-colors">{university.name}</h3>
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-medium text-foreground">{university.ratings.studentSatisfaction}/5</span>
              </div>
              <Progress 
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-medium text-foreground">{university.ratings.academicExcellence}/5</span>
              </div>
              <Progress 
        ...
        {expanded && (
          <div className="mt-4 text-sm text-muted-foreground border-t border-gray-100 pt-4 animate-fadeIn">
            <p className="mb-3">{university.description}</p>
            
            <div className="mb-3">
              <h4 className="font-semibold text-foreground mb-1">Programs Offered:</h4>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <span className="font-semibold text-foreground">Tuition: </span>
