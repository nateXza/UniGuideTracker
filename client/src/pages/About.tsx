      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.ourStory.title', 'Our Story')}</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.ourMission.title', 'Our Mission')}</h2>
              <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.whatWeDo.title', 'What We Do')}</h2>
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.whatWeDo.assessment', 'Personality Assessment')}</h3>
              <p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.whatWeDo.matching', 'University Matching')}</h3>
              <p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('about.whatWeDo.resources', 'Educational Resources')}</h3>
              <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.team.title', 'Our Team')}</h2>
          <p className="mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            <div className="text-center">
              <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center text-gray-500 text-2xl font-semibold">JM</div>
              <h3 className="font-semibold">{t('about.team.member1.name', 'Dr. John Mokoena')}</h3>
              <p className="text-gray-600 text-sm">{t('about.team.member1.role', 'Founder & Education Director')}</p>
            </div>
            <div className="text-center">
              <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center text-gray-500 text-2xl font-semibold">SP</div>
              <h3 className="font-semibold">{t('about.team.member2.name', 'Sarah Patel')}</h3>
              <p className="text-gray-600 text-sm">{t('about.team.member2.role', 'Career Assessment Specialist')}</p>
            </div>
            <div className="text-center">
              <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center text-gray-500 text-2xl font-semibold">TN</div>
              <h3 className="font-semibold">{t('about.team.member3.name', 'Thabo Ndlovu')}</h3>
              <p className="text-gray-600 text-sm">{t('about.team.member3.role', 'Data Science Lead')}</p>
            </div>
            <div className="text-center">
              <div className="w-24 h-24 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center text-gray-500 text-2xl font-semibold">LB</div>
              <h3 className="font-semibold">{t('about.team.member4.name', 'Lerato Botha')}</h3>
              <p className="text-gray-600 text-sm">{t('about.team.member4.role', 'University Relations Manager')}</p>
            </div>
          </div>
          
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.values.title', 'Our Values')}</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('about.contact.title', 'Contact Us')}</h2>
          <p>
